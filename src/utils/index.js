...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://ioswap.io/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://ioswap.io/#/swap?inputCurrency=${
      token0Address === '0x8f8526dbfd6e38e3d8307702ca8469bae6c56c15' ? 'OKT' : token0Address
...
export function getMiningPoolLink(token0Address) {
  return `https://ioswap.io/#/uni/ETH/${token0Address}`
}

export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://ioswap.io/#/uni'
  if (!linkVariable) {
